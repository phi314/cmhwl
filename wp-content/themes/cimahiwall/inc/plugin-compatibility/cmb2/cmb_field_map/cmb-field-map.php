...
class PW_CMB2_Field_Google_Maps {
	...
	public function setup_admin_scripts() {
		wp_register_script( 'pw-google-maps-api', 'https://maps.google.com/maps/api/js?key=' . cmb2_get_option('cimahiwall_theme_options', 'google_map_api_key'), null, null );
		wp_enqueue_script( 'pw-google-maps', get_template_directory_uri() . '/inc/plugin-compatibility/cmb2/cmb_field_map/js/script.js', array( 'pw-google-maps-api' ), self::VERSION );
		wp_enqueue_style( 'pw-google-maps', get_template_directory_uri() . '/inc/plugin-compatibility/cmb2/cmb_field_map/css/style.css', array(), self::VERSION );
	}
}
