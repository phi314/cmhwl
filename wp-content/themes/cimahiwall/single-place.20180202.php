...
//                    ?>
<!--                    <a href="--><?php //echo $photo; ?><!--" class="top-slider-item"><img title="Hotel photo" src="--><?php //echo $photo; ?><!--"></a>-->
<!--                    --><?php
//                endforeach;
                ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="service-box">
                                        ...
                                        <div class="service-content">
                                            <h4>IDR <?php echo $zomato_place->average_cost_for_two; ?></h4>
                                            <p>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="service-box">
                                        ...
                                        <div class="service-content">
                                            <h4>
                                                <?php for ($i = 1; $i <= $zomato_place->price_range; $i++) echo "$" ?>
                                            </h4>
                                            <p>
                                                Range Harga
                                            </p>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="service-box">
                                        ...
                                        <div class="service-content">
                                            <h4>Masakan</h4>
                                            <p>
                                                <?php echo $zomato_place->cuisines; ?>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-4">
                    ...
                    <?php if( $is_hotel ) : ?>
                        ...
                        <section>
                            ...
                            <h3 class="text-center"><?php echo $tiket_dot_com->price; ?></h3>
                            ...
                            <div class="text-center pb-3">
                                <a href="<?php echo $tiket_dot_com_url; ?>">
                        ...
                        <div class="">
                            ...
                            <ul class="list-style social-list pl-0">
                                ...
                                <?php if( ! empty($google_place->website) ) : ?>
                                    <li>
                                        <a href="<?php echo $google_place->website; ?>"><i class="fa fa-link"></i> <?php limit_text($google_place->website, 70); ?></a>
                                    </li>
                                <?php endif; ?>
